...
from andes.core.block import (GainLimiter, HVGate, Lag, GainLimiter,
                              LVGate, Washout, )
...
class ESST1AV2Data(ExcBaseData):
    """
    ESST1AV2 data.
    """
...
class ESST1AV2Model(ExcBase, ExcVsum):
    """
    Implementation of the ESST1AV2 model.
    """
    ...
    def __init__(self, system, config):
        ...
        self.LA = GainLimiter(u=self.HVG1_y,
                       K=self.KA,
                       R=1,
                       upper=self.VAMAX,
                       lower=self.VAMIN,
...
class ESST1AV2(ESST1AV2Data, ESST1AV2Model):
    """
    Exciter ESST1AV2 model.

    Reference:

    [1] PowerWorld, Exciter ESST1AV2, [Online],
    ...
    def __init__(self, system, config):
        ESST1AV2Data.__init__(self)
        ESST1AV2Model.__init__(self, system, config)
