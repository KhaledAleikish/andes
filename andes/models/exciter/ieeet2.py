...
class IEEET2Data(ExcBaseData):
    def __init__(self):
        ...
        self.TF1 = NumParam(default=1.0,
                           info='Feedback delay',
                           tex_name='T_F',
                           non_negative=True,
                           non_zero=True,
                           )
        self.TF2 = NumParam(default=1.0,
                           info='Feedback delay',
                           tex_name='T_{F2}',
                           non_negative=True,
                           non_zero=True,
...
class IEEET2Model(ExcBase):
    ...
    def __init__(self, system, config):
        ...
        self.LA = LagAntiWindup(u='ue * (vi - WF2_y)',
                                T=self.TA,
                                K=self.KA,
                                upper=self.VRMAXc,
                                lower=self.VRMIN,
        ...
        self.WF = Washout(u=self.vout, T=self.TF1, K=self.KF, info='Stablizing circuit feedback')
        self.WF2 = Lag(u=self.WF_y, T=self.TF2, K=1)


        self.vout.e_str = 'ue * (INT_y - vout)'


class IEEET2(IEEET2Data, IEEET2Model):
    """
    IEEET2 exciter.
    """

    def __init__(self, system, config):
        IEEET2Data.__init__(self)
        IEEET2Model.__init__(self, system, config)
