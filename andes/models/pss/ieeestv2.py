...
class IEEESTV2Data(PSSBaseData):
    def __init__(self):
        super().__init__()
...
class IEEESTV2Model(PSSBase):
    """
    IEEESTV2 Stabilizer equation.
    """
    ...
    def __init__(self, system, config):
        ...
        self.LL1 = LeadLag(u=self.sig, T1=self.T1, T2=self.T2, zero_out=True)
...
class IEEESTV2(IEEESTV2Data, IEEESTV2Model):
    """
    IEEEST stabilizer model without filter.
    """

    def __init__(self, system, config):
        IEEESTV2Data.__init__(self)
        IEEESTV2Model.__init__(self, system, config)
