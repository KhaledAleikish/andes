...
from andes.core.block import Lag2ndOrdV2, LeadLag2ndOrd, Gain, WashoutOrLag
...
class IEEESTV3Data(PSSBaseData):
    def __init__(self):
        super().__init__()
...
class IEEESTV3Model(PSSBase):
    """
    IEEESTV3 Stabilizer equation.
    """
    ...
    def __init__(self, system, config):
        ...
        self.F1 = Lag2ndOrdV2(u=self.sig, K=1, T1=self.A1, T2=self.A2, zero_out=True)
...
class IEEESTV3(IEEESTV3Data, IEEESTV3Model):
    """
    IEEEST stabilizer model with LessThan.
    """

    def __init__(self, system, config):
        IEEESTV3Data.__init__(self)
        IEEESTV3Model.__init__(self, system, config)
